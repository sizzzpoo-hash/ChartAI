...
7.  **Analyze the Primary Chart (For Entry):** Now focus on the primary chart ({{{chartDataUri}}}). In the context of the established macro trend, look for specific entry signals.
...
9.  **Analyze Volume Subtleties & Context:** Examine the volume data from the OHLCV payload again, but with more nuance. Go beyond simply "high" or "low" volume.
